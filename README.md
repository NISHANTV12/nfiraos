...
* nfiraos-assembly - an assembly that talks to the nfiraos HCD
* nfiraos-hcd - an HCD that talks to the nfiraos hardware
* nfiraos-deploy - for starting/deploying HCD's and Assembly's
